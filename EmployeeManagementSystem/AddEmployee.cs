...
namespace EmployeeManagementSystem
{
    public partial class AddEmployee : UserControl
    {
        SqlConnection connect =
            new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Felicity Mae M. Sy\Documents\employee.mdf;Integrated Security=True;Connect Timeout=30");
                    ...
                    try
                    {
                        ...
                        using (SqlCommand checkEm = new SqlCommand(checkEmID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\Felicity Mae M. Sy\Documents\C# INTEGPRO\EmployeeManagementSystem\EmployeeManagementSystem\Directory\"
